...
model = joblib.load(r"D:\streamlit_project\streamlit_crop\env\Scripts\rf_model_1.pkl")
feature_columns = joblib.load(r"D:\streamlit_project\streamlit_crop\env\Scripts\feature_columns.pkl")

df_cleaned = pd.read_csv(r"D:\streamlit_project\streamlit_crop\env\Scripts\df_cleaned.csv")
